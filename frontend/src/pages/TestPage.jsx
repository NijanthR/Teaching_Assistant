...
async function requestGeneratedMcqQuestions(topic, level, count = QUESTION_COUNT) {
  const response = await fetch(apiUrl('/api/test/mcq/generate/'), {
    method: 'POST',
...
async function requestGeneratedCodingChallenge(topic, difficulty = 'medium') {
  const response = await fetch(apiUrl('/api/test/coding/generate/'), {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
...
async function requestRunCodingTest(code, functionName, testCases) {
  const response = await fetch(apiUrl('/api/test/coding/run/'), {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      code,
